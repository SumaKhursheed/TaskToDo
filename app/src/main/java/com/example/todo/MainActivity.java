...
import com.example.todo.adapters.MainFragmentPagerAdapter;
import com.example.todo.recognition.RecognitionManager;
...
public class MainActivity extends AppCompatActivity implements RecognitionListener , RuntimePermissionListener {
    ...
    public void onError(int error) {
       ...
       //Toast.makeText(this, "\n" +
         //      "There was an error while performing voice recognition. Error code : " + error, Toast.LENGTH_SHORT).show();
    ...
    public void onResults(Bundle results) {
        ...
        if(textMatchList != null && !textMatchList.isEmpty())
        {
            ...
            Toast.makeText(this, "Recognition Result : " + textMatchList.get(0), Toast.LENGTH_SHORT).show();
    ...
    public void onShowPermissionRationale(List<String> permissionList, final RuntimePermissionRequest permissionRequest) {
        ...
        new AlertDialog.Builder(this, R.style.AppCompatProgressDialogStyle).setTitle("Needs Seizure!")
                .setMessage("I need a microphone to make voice recognition.")
                .setCancelable(true)
                .setNegativeButton("No Thankyou", new DialogInterface.OnClickListener() {
                    @Override
    ...
    public void onPermissionDenied(List<DeniedPermission> deniedPermissionList) {
        ...
        new AlertDialog.Builder(this, R.style.AppCompatProgressDialogStyle).setTitle("Allow Settings By Increasing")
                .setMessage("\n" +
                        "I need a microphone to make voice recognition.")
                .setCancelable(true)
